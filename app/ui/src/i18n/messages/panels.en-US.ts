...
export const enPanels: Record<keyof typeof zhPanels, string> = {
  ...
  'panels.jobScanning': 'Scanning…',
  'panels.jobTransferring': 'Transferring',
  'panels.jobFinalizing': 'Finalizing',
  'panels.jobFailedCount': '{count} failed',
  'panels.jobStarted': 'Directory job started — see Transfer Center',
  'panels.jobCurrent': 'In flight',
  'panels.jobFailures': 'Failed entries',
  'panels.jobMoreEntries': '…and {count} more',
